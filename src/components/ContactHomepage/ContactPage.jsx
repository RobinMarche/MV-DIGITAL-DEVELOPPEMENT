...
export default function ContactPage() {
  ...
  return (
    <div className="mt-10 flex flex-col justify-center items-center">
        <div className="px-4 flex flex-col items-center justify-center lg:w-1/2 pb-10 m-4">
            <div>
                <h1 className={`text-3xl uppercase text-center lg:text-start fade-in`}>Vous avez un projet ? Contactez-nous !</h1>
        ...
        <div className="flex justify-between flex-col lg:flex-row">
            <div className='flex flex-col items-center lg:mt-12 lg:mr-48  lg:pl-24'>
                <div className={`flex flex-col justify-center items-center border mb-8 px-8 py-16 w-[60vw] xl:w-[20vw] rounded-xl rounded-tr-[50%] shadow-xl lg:w-auto lg:mr-16 bg-white text-black `}>
                    <p>06.33.90.40.50</p>
                    <p>06.81.74.23.42</p>
                    <p>mvdigital3989@gmail.com</p>
                </div>
                <div className={`flex flex-col justify-center items-center border px-8 py-16 w-[60vw] xl:w-[20vw] rounded-xl rounded-bl-[50%] shadow-xl lg:w-auto bg-white text-black bg-blue-400`}>
            ...
            <div className='p-8'>
                ...
                <form className="w-full flex flex-col">
                    <div className="mx-16 md:mx-48 lg:mx-0">
                        <div className={`bg-white flex items-center border border-[#022e60] rounded-full py-2 my-8`}>
                        ...
                        <div className={`bg-white flex items-center border border-[#022e60] rounded-full py-2`}>
