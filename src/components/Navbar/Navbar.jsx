...
export default function Navbar() {
    ...
    return (
        ...
        <div className='relative lg:hidden z-10'>
            ...
            <div className={`flex justify-between p-4 items-center ${showMenu ? 'text-white bg-[#022a60] transition-bg' : 'text-[#022a60]'}`}>
                ...
                <div className="menu-container bg-[#022a60] pb-24 min-h-screen absolute w-full lg:w-1/2 top-14 right-0">
                    ...
                    <footer className="footer pt-10 bg-[#022a60] text-neutral-content flex justify-around items-center">
                        <aside>
                            ...
                            <p>M&V Digital Developpement<br/>Agence de communication depuis 2023</p>
                        </aside> 
                        <nav>
