...
export default function Equipe() {
    ...
    return (
        ...
        <div className='pb-12'>
            ...
            <div className='lg:flex justify-around items-center py-12 bg-gray-100'>
                <div className={`flex justify-center flex-col items-center ${scrollY > 10 ? 'slideInRight' : 'slideOffRight1'} mx-6 lg:w-[40%] 2xl:w-[25%] border-[5px] border-white`}>
                    <img src={thomas} alt="thomas" className='lg:w-[100%]'/>
                    <div className='px-8 pb-12 bg-white'>
                        <p className='text-2xl my-2 text-start font-bold uppercase my-6'>Thomas Vannier</p>
                ...
                <div className={`flex justify-center flex-col items-center mt-8 lg:mt-0 ${scrollY > 10 ? 'slideInRight3' : 'slideOffRight3'} mx-6 lg:w-[40%] 2xl:w-[25%] border-[5px] border-white`}>
                    <img src={robin} alt="robin" className='lg:w-[100%]'/>
                    <div className='px-8 pb-12 bg-white'>
                        <p className='text-2xl my-2 text-start font-bold uppercase my-6'>Robin Marche</p>
            ...
            <div id='equipe_contact' className='flex flex-col text-white justify-center items-center py-12 lg:py-36'>
                ...
                <div className='flex flex-col lg:flex-row justify-center items-center'>
                    ...
                    <Link to="/services">
                        <button className='btn bg-orange-500 text-white my-8 lg:mt-24 lg:px-12 border-none'>Découvrez nos services</button>
                    </Link>
                </div>
            </div>
        </div>
